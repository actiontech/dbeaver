...
public class PrefPageSQLEditor extends TargetPrefPage
{
    ...
    protected void loadPreferences(DBPPreferenceStore store)
    {
        try {
            ...
            sizeWarningThreshouldSpinner.setSelection(store.getInt(SQLPreferenceConstants.RESULT_SET_LIMIT));
        } catch (Exception e) {
            log.warn(e);
        }
    }
    ...
    protected void savePreferences(DBPPreferenceStore store)
    {
        try {
            ...
            store.setValue(SQLPreferenceConstants.RESULT_SET_LIMIT, sizeWarningThreshouldSpinner.getSelection());
        } catch (Exception e) {
            log.warn(e);
        }
    ...
    protected void clearPreferences(DBPPreferenceStore store)
    {
        ...
        store.setToDefault(SQLPreferenceConstants.RESULT_SET_LIMIT);
